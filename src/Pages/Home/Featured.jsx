    ...
    return (
        <section className="featured--section" id="Featured">
            <div className="featured--container-box">
                ...
                <div>   
                    <button className="btn btn-github" onClick={() => window.open("https://github.com/ali-naqvi8062", "_blank")}>
                        <svg
            ...
            <div className="featured--section--container">
                {data?.featured?.map((item, index) => (
                    <div key={index} className="featured--section--card">
                        <div className="featured--section--img">
                            <img src={item.src} alt="Placeholder"/>
                        </div>
                        <div className="featured--section--card--content">
                            <div>
                            ...
                            {item.link && (
                                <p className="text-sm featured--link">
                                    <a href={item.link} target="_blank" rel="noopener noreferrer">
                                        {item.linkText || "View in GitHub"}
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            width="16"
                                            height="16"
